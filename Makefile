...
ifeq ($(detected_OS),Darwin)
	...
	cd Examples/mach1-example/Audio/Nature && wget $(IOSDIR)/mach1-example/Nature/Nature_Mono01.wav && wget $(IOSDIR)/mach1-example/Nature/Nature_Mono02.wav && wget $(IOSDIR)/mach1-example/Nature/Nature_Mono03.wav
	cd Examples/mach1-example/Audio/SciFi && wget $(IOSDIR)/mach1-example/SciFi/SciFi_Mono01.wav && wget $(IOSDIR)/mach1-example/SciFi/SciFi_Mono02.wav && wget $(IOSDIR)/mach1-example/SciFi/SciFi_Mono03.wav
	cd Examples/mach1-example/Audio/StereoTest && wget $(IOSDIR)/mach1-example/StereoTest/M1_SDKDemo_Orchestral_Stereo_L.wav && wget $(IOSDIR)/mach1-example/StereoTest/M1_SDKDemo_Orchestral_Stereo_R.wav
	cd Examples/mach1-transcode-example/ACNSN3D && wget $(IOSDIR)/mach1-transcode-example/ACNSN3D/guitar-acnsn3d-1.wav && wget $(IOSDIR)/mach1-transcode-example/ACNSN3D/guitar-acnsn3d-2.wav && wget $(IOSDIR)/mach1-transcode-example/ACNSN3D/guitar-acnsn3d-3.wav && wget $(IOSDIR)/mach1-transcode-example/ACNSN3D/guitar-acnsn3d-4.wav && 
	cd Examples/mach1-transcode-example/FiveOneFilm_Cinema && wget $(IOSDIR)/mach1-transcode-example/FiveOneFilm_Cinema/guitar-51Film-1.wav && wget $(IOSDIR)/mach1-transcode-example/FiveOneFilm_Cinema/guitar-51Film-2.wav && wget $(IOSDIR)/mach1-transcode-example/FiveOneFilm_Cinema/guitar-51Film-3.wav && wget $(IOSDIR)/mach1-transcode-example/FiveOneFilm_Cinema/guitar-51Film-4.wav && wget $(IOSDIR)/mach1-transcode-example/FiveOneFilm_Cinema/guitar-51Film-5.wav && wget $(IOSDIR)/mach1-transcode-example/FiveOneFilm_Cinema/guitar-51Film-6.wav
endif
ifeq ($(detected_OS),Windows)
endif

build: setup
	cd Examples/mach1-example && pod install
